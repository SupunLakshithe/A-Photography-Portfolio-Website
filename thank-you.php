...
<body class="contactbody">
    <div class="container align-items-center">
        ...
        <div class="container-fluid px-5 my-5 thankyou">
                        ...
                        <div class="card-body p-0">
                            <div class="row g-0">
                                ...
                                <div class="col-sm-6 p-4 text-center">
                                    <h3>We Receaved your data <br> We will contact you asap...<br>  <br>Thank you for choosing us!!! </h3>
                                    <a class="text-center" href="http://localhost/photgrapher-website/index.php"><Button>Home</Button></a>
